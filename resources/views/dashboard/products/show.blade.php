...
<div class="container">
    <div class="d-flex justify-content-between mb-3">
        ...
        <a href="{{ route('products.index') }}" class="btn btn-outline-secondary btn-sm radius-8">{{ __('messages.back') }}</a>
    </div>
    ...
    <div class="card p-3">
        ...
        @if ($installmentContracts->isEmpty())
            <div class="text-muted">{{ __('messages.no_installment_contracts') }}</div>
        @else
