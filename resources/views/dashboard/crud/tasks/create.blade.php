        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-12">
                <div class="card border-0">
                    ...
                    <form class="card-body" method="POST" action="{{ route('tasks.store') }}">
                        @csrf
                        <div class="row g-3">
                            <div class="col-md-6">
                                <x-forms.input-label.basic name="title" required value="{{ old('title') }}">
                                    Title
                                </x-forms.input-label.basic>
                            </div>

                            <div class="col-md-6">
                                <x-forms.input-label.basic name="due_date" required value="{{ old('due_date') }}"
                                                           type="date">
                                    Due date
                                </x-forms.input-label.basic>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <x-forms.textarea.basic name="notes" value="{{ old('notes') }}"/>
                            </div>
